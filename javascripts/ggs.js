...
var switchColor = 'rgba(0,0,0,.3)';
var switchOpacity = '0.618';

var baseFontSize = 16;
var baselineGridHeight = (24 / baseFontSize)+'em';

var eightColBreakpoint = ((640-1) / baseFontSize)+'em';
var sixteenColBreakpoint = ((1900-1) / baseFontSize)+'em';
...
/*  Create CSS */
    var styles = '\
        ...
        #ggs-baseline-container {opacity: '+guideOpacity+'; position: absolute; left:0; top:0; z-index: 0; width: 100%; height: 100%; -webkit-transition: opacity 0.235s ease-out; -moz-transition: opacity 0.235s ease-out; -ms-transition: opacity 0.235s ease-out; transition: opacity 0.235s ease-out; overflow-y: hidden;}\
        .ggs-line {border-top: 1px solid '+guideColor+'; height: '+baselineGridHeight+'; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; -o-box-sizing: border-box; box-sizing: border-box;}\
